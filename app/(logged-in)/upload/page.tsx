    ...
    <section className="min-h-screen px-4 sm:px-6 py-12 sm:py-20">
      ...
      <div className="max-w-7xl mx-auto flex flex-col items-center justify-center gap-10 text-center">
        ...
        <motion.div 
          ...
          className="w-full max-w-4xl bg-white/80 dark:bg-gray-900/80 backdrop-blur-sm rounded-xl p-6 border border-gray-100 dark:border-gray-800 shadow-sm"
        >
          <h2 className="text-xl font-semibold mb-6 text-gray-800 dark:text-gray-100">How It Works</h2>
          <div className="flex flex-wrap justify-between items-center">
            <div className="flex flex-col items-center p-3 min-w-[120px]">
              <div className="w-14 h-14 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center mb-3">
                <FileText className="w-6 h-6 text-yellow-600 dark:text-yellow-400" />
              </div>
              <p className="text-sm font-medium dark:text-gray-300">Upload PDF</p>
            </div>
            
            <ArrowRight className="w-5 h-5 text-gray-400 dark:text-gray-600 hidden md:block" />
            ...
            <div className="flex flex-col items-center p-3 min-w-[120px]">
              ...
              <p className="text-sm font-medium dark:text-gray-300">Extract Text</p>
            </div>
            ...
            <div className="flex flex-col items-center p-3 min-w-[120px]">
              <div className="w-14 h-14 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mb-3">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-6 h-6 text-green-600 dark:text-green-400">
              ...
              <p className="text-sm font-medium dark:text-gray-300">Generate Summary</p>
            </div>
            
            <ArrowRight className="w-5 h-5 text-gray-400 dark:text-gray-600 hidden md:block" />
            
            <div className="flex flex-col items-center p-3 min-w-[120px]">
              <div className="w-14 h-14 bg-purple-100 dark:bg-purple-900/30 rounded-full flex items-center justify-center mb-3">
                <Database className="w-6 h-6 text-purple-600 dark:text-purple-400" />
              </div>
              <p className="text-sm font-medium dark:text-gray-300">Save Result</p>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div
          ...
          className="text-sm text-gray-500 dark:text-gray-400 max-w-lg text-center mt-4"
        >
